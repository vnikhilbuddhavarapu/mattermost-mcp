/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fef3f895e8675c47f25aa65d017d1e1d)
// Runtime types generated with workerd@1.20260317.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MattermostMCP";
	}
	interface Env {
		MATTERMOST_URL: string;
		MATTERMOST_TOKEN: string;
		MATTERMOST_TEAM_ID: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").MattermostMCP>;
	}
}
